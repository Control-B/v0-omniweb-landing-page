...
import { ArrowRight, Calculator, CheckCircle2, DollarSign, Sparkles, TrendingDown, TrendingUp, Users, Zap } from "lucide-react"
...
export function CallCenterRoiCalculator() {
  ...
  // Omniweb AI Swarm Cost: $0.09 / minute + $49 platform fee
        ...
        <div className="space-y-6 lg:col-span-6 rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-900/60 p-4 sm:p-6">
          <div>
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-mono font-bold text-cyan-400 text-base">{seats} Agents</span>
            </div>
            <input
              type="range"
              min={2}
          ...
          <div>
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-mono font-bold text-purple-400 text-base">{callsPerDay} Calls</span>
            </div>
            <input
              type="range"
              min={20}
              ...
              className="mt-3 w-full accent-purple-400 cursor-pointer"
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-mono font-bold text-amber-400 text-base">{avgDurationMins} Minutes</span>
            </div>
            <input
              type="range"
              min={1}
          ...
          <div className="rounded-2xl border border-white/5 bg-black/30 p-4 text-xs text-slate-400 space-y-2">
        ...
        <div className="lg:col-span-6 rounded-2xl sm:rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-950/40 via-slate-950/90 to-cyan-950/40 p-4 sm:p-8 shadow-2xl">
          ...
          <div className="mt-5">
            ...
            <div className="text-4xl font-extrabold tracking-tight text-white lg:text-5xl">
              ${monthlySavings.toLocaleString()} <span className="text-lg font-normal text-emerald-400">/ month</span>
            </div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 border-t border-white/10 pt-6 text-xs">
            <div className="rounded-xl border border-white/5 bg-black/40 p-3">
              <span className="text-slate-500 font-semibold uppercase">Human Call Center</span>
              <p className="mt-1 text-base font-bold text-rose-400">${humanMonthlyCost.toLocaleString()}/mo</p>
            </div>
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3">
              <span className="text-emerald-400 font-semibold uppercase">Omniweb AI Swarm</span>
              <p className="mt-1 text-base font-bold text-emerald-300">${omniwebMonthlyCost.toLocaleString()}/mo</p>
            </div>
          </div>

          <Button asChild size="lg" className="mt-6 w-full rounded-2xl bg-gradient-to-r from-emerald-500 to-cyan-500 font-bold text-black hover:from-emerald-400 hover:to-cyan-400">
            <Link href="/get-started">
              Deploy Your Autonomous Contact Center
