...
export function CallCenterRoiCalculator() {
  ...
  return (
    <div className="w-full max-w-full min-w-0 overflow-hidden rounded-2xl sm:rounded-[2.5rem] border border-white/15 bg-gradient-to-b from-slate-950/95 to-[#081020]/95 p-4 sm:p-6 lg:p-10 shadow-2xl backdrop-blur-2xl">
      ...
      <div className="mt-8 sm:mt-10 grid gap-6 sm:gap-8 lg:grid-cols-12 lg:items-center w-full min-w-0 max-w-full">
        ...
        <div className="w-full min-w-0 max-w-full space-y-6 lg:col-span-6 rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-900/60 p-4 sm:p-6 overflow-hidden">
          <div className="w-full min-w-0">
            <div className="flex flex-wrap items-center justify-between gap-1 text-sm sm:text-base">
              ...
              <span className="font-mono font-bold text-cyan-400 text-base sm:text-lg">{seats} Agents</span>
            </div>
            <input
              type="range"
              min={2}
            ...
            />
            <div className="mt-1 flex justify-between text-xs sm:text-sm text-slate-400 font-medium">
              <span>2 seats</span>
              <span>50 seats</span>
              <span>150 seats</span>
            </div>
          ...
          <div className="w-full min-w-0">
            <div className="flex flex-wrap items-center justify-between gap-1 text-sm sm:text-base">
              ...
              <span className="font-mono font-bold text-purple-400 text-base sm:text-lg">{callsPerDay} Calls</span>
            </div>
            <input
              type="range"
              min={20}
          ...
          <div className="w-full min-w-0">
            <div className="flex flex-wrap items-center justify-between gap-1 text-sm sm:text-base">
              ...
              <span className="font-mono font-bold text-amber-400 text-base sm:text-lg">{avgDurationMins} Minutes</span>
            </div>
            <input
              type="range"
              min={1}
          ...
          <div className="rounded-2xl border border-white/5 bg-black/30 p-4 text-sm text-slate-300 space-y-2.5">
            <div className="flex items-start gap-2.5 text-slate-200 font-medium">
        ...
        <div className="w-full min-w-0 max-w-full lg:col-span-6 rounded-2xl sm:rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-950/40 via-slate-950/90 to-cyan-950/40 p-5 sm:p-8 shadow-2xl overflow-hidden">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <span className="text-xs sm:text-sm font-semibold uppercase tracking-[0.2em] text-emerald-300">Projected Savings</span>
            <Badge className="bg-emerald-500 text-black font-bold text-xs sm:text-sm">{percentageSavings}% Cost Cut</Badge>
          </div>

          <div className="mt-5 w-full min-w-0">
            <span className="text-xs sm:text-sm font-medium text-slate-300 uppercase tracking-wider">Monthly Net Savings</span>
            <div className="mt-1 flex flex-wrap items-baseline gap-1.5 text-4xl sm:text-5xl font-extrabold tracking-tight text-white break-words">
              <span>${monthlySavings.toLocaleString()}</span>
              <span className="text-base sm:text-lg font-normal text-emerald-400">/ month</span>
            </div>
            <div className="mt-1.5 text-sm sm:text-base font-semibold text-emerald-300 break-words">
          ...
          <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 border-t border-white/10 pt-5 sm:pt-6 w-full min-w-0">
            ...
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3.5 min-w-0">
              <span className="text-emerald-400 font-semibold uppercase text-xs sm:text-sm">Omniweb AI Swarm</span>
              <p className="mt-1 text-lg sm:text-xl font-bold text-emerald-300 break-words">${omniwebMonthlyCost.toLocaleString()}/mo</p>
            </div>
          </div>
