...
export default function CompanyPage() {
  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.email || !formData.message) {
      setFormError("Please provide your email address and a message.")
      return
    }
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { label: "Partnerships", href: "/company/partners" },
                      { label: "Developer API", href: "/resources/docs" },
                      { label: "About Omniweb", href: "/company/about" },
                      { label: "Pricing & Plans", href: "/pricing" },
                    ].map((link) => (
                      <Link key={link.label} href={link.href} className="kling-panel flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm text-white/60 transition-colors hover:border-white/20 hover:text-white">
                ...
                {isSubmitted ? (
                  <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-8 text-center backdrop-blur-xl">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-slate-300">
                      Thank you! Your message has been routed to our team. We typically respond within 2 business hours.
                    </p>
                    <Button
                      type="button"
                      onClick={() => setIsSubmitted(false)}
                      variant="outline"
                      className="mt-6 border-white/20 bg-white/5 text-xs text-white hover:bg-white/10"
                    >
                  ...
                  <form onSubmit={handleContactSubmit} className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <Input
                          ...
                          className="border-white/10 bg-white/5 placeholder:text-white/20 focus-visible:ring-cyan-500"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-lg border border-white/10 bg-[#0c1427] px-3 py-2.5 text-sm text-white focus:outline-none focus:ring-1 focus:ring-cyan-500"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/20 focus:border-cyan-500/50 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 resize-none"
                      />
                    </div>
                    <Button
                      type="submit"
                      ...
                      size="lg"
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 font-semibold hover:from-blue-700 hover:to-purple-700"
                    >
