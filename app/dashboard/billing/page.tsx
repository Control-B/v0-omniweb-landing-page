    ...
    <div className="space-y-6">
      <section className="grid gap-5 lg:grid-cols-3">
        <div className="flex min-h-[260px] flex-col rounded-[28px] border border-slate-200/80 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">Track plan status, renewal timing, and trial state for this workspace.</p>
      ...
      <section id="billing-plans" className="space-y-4 rounded-[28px] border border-slate-200/80 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">Compare Starter, Standard, and Business in one place. Each plan keeps a single clear CTA with no duplicate upgrade rows.</p>
        </div>
